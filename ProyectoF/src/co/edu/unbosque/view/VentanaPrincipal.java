...
public class VentanaPrincipal extends JFrame {
	...
	public void inicializarComponentes() {
		...
		botonBuscar.setBounds(850, 200, 80, 35);
		...
		comboBoxFiltrar.setBounds(970, 150, 200, 35);
		comboBoxFiltrar.addItem("Letra inicial");
		comboBoxFiltrar.addItem("Id");
		comboBoxFiltrar.addItem("Titulo");
		comboBoxFiltrar.addItem("Clasificacion");
		comboBoxFiltrar.addItem("Facultad");
		comboBoxFiltrar.addItem("Idioma");
		comboBoxFiltrar.addItem("Fecha de publicacion");
		this.add(comboBoxFiltrar);
	}
